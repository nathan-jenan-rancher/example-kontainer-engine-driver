...
type BoolPointer int32

const (
	BoolPointer_TRUE  BoolPointer = 0
	BoolPointer_FALSE BoolPointer = 1
	BoolPointer_NIL   BoolPointer = 2
)

var BoolPointer_name = map[int32]string{
	0: "TRUE",
	1: "FALSE",
	2: "NIL",
}
var BoolPointer_value = map[string]int32{
	"TRUE":  0,
	"FALSE": 1,
	"NIL":   2,
}

func (x BoolPointer) String() string {
	return proto.EnumName(BoolPointer_name, int32(x))
}
func (BoolPointer) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type DriverOptions struct {
	...
	BoolPointerOptions map[string]BoolPointer  `protobuf:"bytes,5,rep,name=bool_pointer_options,json=boolPointerOptions" json:"bool_pointer_options,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=types.BoolPointer"`
}
...
func (m *DriverOptions) GetBoolPointerOptions() map[string]BoolPointer {
	if m != nil {
		return m.BoolPointerOptions
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("types.BoolPointer", BoolPointer_name, BoolPointer_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
